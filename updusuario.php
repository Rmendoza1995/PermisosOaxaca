...
<body>
    <div class="container">
        ...
        $sql = "SELECT * FROM useros WHERE usuario = '$usuario'";
        $resultado = $link->query($sql);
        if ($resultado->num_rows > 0) {
            while ($fila = $resultado->fetch_assoc()) {
                echo "<form method='post' action='" . $_SERVER["PHP_SELF"] . "'>";
        echo "<input type='hidden' name='id_eliminar' value='" . $fila['id_usuarios'] . "'>";
        ...
        echo "</form>";
                ...
                echo "<input type='hidden' name='id' value='" . $fila['id_usuarios'] . "'>"; // Campo oculto para enviar el ID del registro
...
if (isset($_POST['eliminar'])) {
    ...
    $sql_eliminar = "DELETE FROM useros WHERE id_usuarios = $id_eliminar";
